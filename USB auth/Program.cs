...
namespace USB_auth
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            String Username = ""; //Username. Setting password for automatic authentication (unrecommended) can be done further below. If you're doing this make sure to set "tryagain" to false!
